...
#### The study of important attributes for voice recognition and their intervariability on each other using the inferences drawn from the various regression plots, pair plots, scatter plots , etc.
